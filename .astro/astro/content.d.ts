...
declare module 'astro:content' {
	...
	type ContentEntryMap = {
		"blog": {
"algoritmos/algoritmos-arbol.md": {
	id: "algoritmos/algoritmos-arbol.md";
  slug: "algoritmos/algoritmos-arbol";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
"algoritmos/algoritmos-grafos.md": {
	id: "algoritmos/algoritmos-grafos.md";
  slug: "algoritmos/algoritmos-grafos";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
"algoritmos/busqueda.md": {
	id: "algoritmos/busqueda.md";
  slug: "algoritmos/busqueda";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
"algoritmos/cache.md": {
	id: "algoritmos/cache.md";
  slug: "algoritmos/cache";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
"algoritmos/greedy.md": {
	id: "algoritmos/greedy.md";
  slug: "algoritmos/greedy";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
"algoritmos/index.md": {
	id: "algoritmos/index.md";
  slug: "algoritmos";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
"algoritmos/recursion.mdx": {
	id: "algoritmos/recursion.mdx";
  slug: "algoritmos/recursion";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".mdx"] };
"algoritmos/sorting.md": {
	id: "algoritmos/sorting.md";
  slug: "algoritmos/sorting";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
